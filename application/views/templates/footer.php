 ...
 <footer class="sticky-footer bg-white">
     <div class="container my-auto">
         <div class="copyright text-center my-auto">
             <span>Copyright &copy; -M_<em style="color: blue;">Project </em><?= date('Y'); ?> | Build by <a href="https://github.com/NXRts" target="_blank">NXRts </a>| Theme <a href="https://startbootstrap.com/themes/sb-admin-2"> SB Admin 2</a>
             </span>
         </div>
     </div>
